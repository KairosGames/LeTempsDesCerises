...
const GAMEPAD_A: Texture2D = preload("uid://bx8t142ru7boq")
const GAMEPAD_B: Texture2D = preload("uid://del3n5p1ntuft")
const GAMEPAD_X: Texture2D = preload("uid://cidv14oem3sdc")
const GAMEPAD_Y: Texture2D = preload("uid://dka2ldcvlxvmw")
