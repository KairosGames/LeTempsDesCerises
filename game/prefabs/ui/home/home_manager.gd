...
@onready var view_sensibility_slider: HSlider = game_settings.get_node(^"ViewSensibility/Slider")
@onready var aiming_sensibility_slider: HSlider = game_settings.get_node(^"AimingSensibility/Slider")
@onready var inverted_check_button: CheckButton = game_settings.get_node(^"Inverted/CheckButton")
@onready var h_multiplier_slider: HSlider = game_settings.get_node(^"HMultiplier/Slider")
@onready var v_multiplier_slider: HSlider = game_settings.get_node(^"VMultiplier/Slider")
@onready var left_stick_deadzone_slider: HSlider = game_settings.get_node(^"DeadzoneLeftStick/Slider")
@onready var right_stick_deadzone_slider: HSlider = game_settings.get_node(^"DeadzoneRightStick/Slider")
@onready var aim_toggle_km_check_button: CheckButton = game_settings.get_node(^"AimToggleKM/CheckButton")
@onready var run_toggle_km_check_button: CheckButton = game_settings.get_node(^"RunToggleKM/CheckButton")
@onready var aim_toggle_gpad_check_button: CheckButton = game_settings.get_node(^"AimToggleGamepad/CheckButton")
@onready var run_toggle_gpad_check_button: CheckButton = game_settings.get_node(^"RunToggleGamepad/CheckButton")
@onready var posture_switch_toggle_km_check_button: CheckButton = game_settings.get_node(^"PostureSwitchToggleKM/CheckButton")
@onready var aim_smooth_check_button: CheckButton = game_settings.get_node(^"AimSmooth/CheckButton")
@onready var movement_smooth_check_button: CheckButton = game_settings.get_node(^"MovementSmooth/CheckButton")
@onready var blood_check_button: CheckButton = game_settings.get_node(^"Blood/CheckButton")
